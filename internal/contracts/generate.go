...
const generatedHeader = "" +
	"# Code generated by internal/contracts; DO NOT EDIT.\n" +
	"# Regenerate: make contracts (or: go generate ./internal/contracts, from the repo root).\n"
...
const infoDescription = "" +
	...
	"internal/contracts, via jsonschema.ForType. The six tool input types and five tool " +
	"output types use the exact bare options value (no overrides) " +
	"cmd/bogoslav-mcp's mcp.AddTool calls use to infer each tool's inputSchema/outputSchema " +
...
// toolForOptions is the exact bare options value cmd/bogoslav-mcp's
...
// domain.Date only inside cmd/bogoslav-mcp's request-mapping
