// Command bogoslav-mcp exposes internal/app's six use cases as MCP
...
// (TZ.md section 7.2), but both bind to the exact same internal/app
...
// internal/mcptool's six *Input types, and five of the six return
...
// 2020-12; see internal/mcptool/schema_test.go). Those types (and
// GetClassifyBatchOutput) live in mcptool, not here, precisely so
// internal/contracts's generator (TZ.md section 10's "go generate"
...
// internal/mcptool, and in internal/contracts's own doc.go.
package main
